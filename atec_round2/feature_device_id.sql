...
drop table if exists t_sj_feature_device_24h_not_now;


create table t_sj_feature_device_24h_not_now as
select t1.event_id,
...
drop table if exists t_sj_feature_device_1h;


create table t_sj_feature_device_1h as
select t1.event_id,
...
drop table if exists t_sj_device_client_ip_24h;


create table t_sj_device_client_ip_24h as
select t1.event_id,
       t2.client_ip,
...
drop table if exists t_sj_device_network_24h;


create table t_sj_device_network_24h as
select t1.event_id,
       t2.network,
...
drop table if exists t_sj_device_user_id_24h;


create table t_sj_device_user_id_24h as
select t1.event_id,
       t2.user_id,
...
drop table if exists t_sj_device_ip_prov_24h;


create table t_sj_device_ip_prov_24h as
select t1.event_id,
       t2.ip_prov,
...
drop table if exists t_sj_device_ip_city_24h;


create table t_sj_device_ip_city_24h as
select t1.event_id,
       t2.ip_city,
...
drop table if exists t_sj_device_mobile_oper_platform_24h;


create table t_sj_device_mobile_oper_platform_24h as
select t1.event_id,
...
drop table if exists t_sj_device_operation_channel_24h;


create table t_sj_device_operation_channel_24h as
select t1.event_id,
...
drop table if exists t_sj_device_pay_scene_24h;


create table t_sj_device_pay_scene_24h as
select t1.event_id,
       t2.pay_scene,
...
-- 3min内
drop table if exists t_sj_device_scatter_freq_24h;


create table t_sj_device_scatter_freq_24h as
select t0.event_id,
       case
...
left outer join t_sj_feature_device_24h_not_now t1 on t0.event_id = t1.event_id
left outer join t_sj_device_client_ip_24h t2 on t0.event_id = t2.event_id
and t0.client_ip = t2.client_ip
left outer join t_sj_device_network_24h t3 on t0.event_id = t3.event_id
and t0.network = t3.network
left outer join t_sj_device_user_id_24h t4 on t0.event_id = t4.event_id
and t0.user_id = t4.user_id
left outer join t_sj_device_ip_prov_24h t5 on t0.event_id = t5.event_id
and t0.ip_prov = t5.ip_prov
left outer join t_sj_device_ip_city_24h t6 on t0.event_id = t6.event_id
and t0.ip_city = t6.ip_city
left outer join t_sj_device_mobile_oper_platform_24h t7 on t0.event_id = t7.event_id
and t0.mobile_oper_platform = t7.mobile_oper_platform
left outer join t_sj_device_operation_channel_24h t8 on t0.event_id = t8.event_id
and t0.operation_channel = t8.operation_channel
left outer join t_sj_device_pay_scene_24h t9 on t0.event_id = t9.event_id
and t0.pay_scene = t9.pay_scene;



drop table if exists t_sj_feature_device;


create table t_sj_feature_device as
select 
t0.event_id,
t1.device_cnt_24h,
...
left outer join t_sj_feature_device_24h_not_now t1 on t0.event_id = t1.event_id
left outer join t_sj_feature_device_1h t2 on t0.event_id = t2.event_id
left outer join t_sj_device_time_diff t3 on t0.event_id = t3.event_id
left outer join t_sj_device_time_diff_not_now t4 on t0.event_id = t4.event_id
left outer join t_sj_device_scatter_freq_24h t5 on t0.event_id = t5.event_id;


-- 去除特征中的缺失值
drop table if exists t_sj_feature_device_notnull;


create table t_sj_feature_device_notnull as
select 
event_id,
...
nvl(gmt_occur_unix_device_diff, 0) as gmt_occur_unix_device_diff,
